...
看到这里你应该下载并安装好了 GM，并且下载好了[果引擎](http://p9wc9w6dq.bkt.clouddn.com/iwbte-nikaple-edition-1.8.0.zip)并将引擎解压到一个文件夹中。准备好之后，便可以开始我们的 I wanna 制作了。
...
I wanna 游戏标准的房间大小应为 800 * 608，如果要做大房间也可以使用更大的数值（比如 1600 * 608 或者 800 * 1824 等等），Speed 设置为 50 。
